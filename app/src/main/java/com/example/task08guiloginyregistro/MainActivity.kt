    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.editTextTextPassword2.addTextChangedListener(object :TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                binding.botonLogin.isEnabled = binding.editTextTextPersonName2.text.toString()==binding.editTextTextPassword2.text.toString() && binding.editTextTextPassword2.text.isNotEmpty()}})
