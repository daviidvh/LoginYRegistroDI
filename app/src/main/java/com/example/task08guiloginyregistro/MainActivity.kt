...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var array= intent.getStringExtra("array")
        ...
        binding.editTextTextPassword2.addTextChangedListener(object :TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                if (array != null) {
                    binding.botonLogin.isEnabled = binding.editTextTextPersonName2.text.toString()==binding.editTextTextPassword2.text.toString() && binding.editTextTextPassword2.text.isNotEmpty() && array.contains( binding.editTextTextPersonName2.text.toString())
                }
            }})
